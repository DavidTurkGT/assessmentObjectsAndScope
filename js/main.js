...
/*************************************************************************************
------------ ANSWER -------------------
console.log(y) will throw a reference error because y is defined only in the function scopeThis scopeThis

console.log(x) will print "I'm a local variable" because scopeThis() has access to var x.
...
console.log(x) will print undefined because var x; will be hoisted to the top of the function warmUp() but the assignment will take place after the console.log(x);

console.log(foo()) will print "function hoisting" because the entire function is hoisted above the console.log statement.
...
/**************************************************************************************
------------ ANSWER -------------------
inside the IIFE console.log(add) will print 4; however outside the IIFE it will throw a reference error because add is not in the global scope
